...
Shader "My PBR/MyPBRAnisoTex"
{
    ...
    CGINCLUDE
        ...
        fixed4 frag(v2f i) : SV_Target
        {
            ...
            float3 specular = (D * G * F * 0.25) * UNITY_PI;   //* UNITY_PI， since there is no divide by UNITY_PI in diffuse, so there is multipy UNITY_PI to instead

            //directLight Diffuse
            //float kd = (1 - F) * (1 - metallic);                 //by metallic
